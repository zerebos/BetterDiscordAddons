            ...
            textarea.on("keypress." + this.getName(), (e) => {this.format(e);})
                ...
                .on("click." + this.getName(), "div", e => {
                    ...
                    if (button.hasClass("bf-arrow")) {
						...
						else if (button.data("name") == "quote") return this.wrapSelection(textarea[0], "> ", null, "\n");
