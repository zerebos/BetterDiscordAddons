...
var BetterFormattingRedux = (() => {
    ...
    return class BetterFormattingRedux extends Plugin {
        constructor() {
            ...
            this.thiccList = "　!\"#$%&'()*+,-./0123456789:;<=>?@丹乃匚刀ヨ下厶ん工丁片乚从几口尸甲尺己卞凵リ山乂ﾘ乙[\\]^_`丹乃匚刀ヨ下厶ん工丁片乚从几口尸甲尺己卞凵リ山乂ﾘ乙{|}";
