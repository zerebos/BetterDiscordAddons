    ...
    return class BetterRoleColors extends Plugin {
        ...
        patchAccountDetails() {
            let colorize = () => {
                ...
                let color = member && member.colorString ? member.colorString : "";
