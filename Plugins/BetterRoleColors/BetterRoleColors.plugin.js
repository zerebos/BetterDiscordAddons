...
var BetterRoleColors = (() => {
    ...
    const {DiscordSelectors, WebpackModules, DiscordModules, PluginUtilities, Patcher, ColorConverter, ReactTools, ReactComponents} = Api;
